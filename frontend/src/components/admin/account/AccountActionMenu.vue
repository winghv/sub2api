...
const emit = defineEmits(['close', 'test', 'stats', 'schedule', 'reauth', 'refresh-token', 'recover-state', 'reset-status', 'clear-rate-limit', 'reset-quota', 'set-privacy', 'create-spark-shadow'])
const { t } = useI18n()
