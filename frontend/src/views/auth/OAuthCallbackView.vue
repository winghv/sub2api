<template>
  <div class="cyber-page min-h-screen px-4 py-10">
    <div class="mx-auto max-w-2xl">
      <div v-if="isProcessing" class="card p-6 text-center">
        ...
        <h1 class="cyber-page-title mt-4 text-lg font-semibold">
          {{ t('auth.oauth.callbackTitle') }}
        </h1>
        <p class="cyber-page-text mt-2 text-sm">
          {{ t('auth.oauth.callbackHint') }}
        </p>
      </div>

      <div v-else-if="needsRegistrationCompletion" class="card p-6">
        <h1 class="cyber-page-title text-lg font-semibold">
        ...
        <div class="mt-6 space-y-4">
          ...
          <p v-if="registrationError" class="text-sm text-red-300">
            {{ registrationError }}
          </p>
          <button
