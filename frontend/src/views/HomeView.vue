<template>
  ...
  <!-- Default Home Page (fork-owned cyber design; keep ours on upstream merge) -->
  <div v-else class="cyber-home" :class="isDark ? 'cyber-home--dark' : 'cyber-home--light'">
    ...
    <footer class="cyber-footer">
      <div class="cyber-footer__inner">
        <p class="cyber-footer__copy">
          &copy; {{ currentYear }} {{ siteName }}. {{ t('home.footer.allRightsReserved') }}
        </p>
        <div class="cyber-footer__links">
          <a
            v-if="docUrl"
            :href="docUrl"
            target="_blank"
...
/* Light mode: same cyber geometry, inverted surface palette */
.cyber-home--light {
  background:
    radial-gradient(circle at 74% 18%, rgba(0, 180, 216, 0.12), transparent 32%),
    radial-gradient(circle at 12% 64%, rgba(34, 197, 94, 0.08), transparent 30%),
...
.cyber-footer__link:hover {
  color: #00e5ff;
}

/* ========== Light mode overrides ========== */
.cyber-home--light::before {
  background:
...
.cyber-home--light .cyber-backdrop__beam {
  border-color: rgba(15, 23, 42, 0.06);
  opacity: 0.55;
}

.cyber-home--light .cyber-backdrop__beam--cyan {
  background: linear-gradient(90deg, transparent, rgba(0, 180, 216, 0.16), transparent);
}

.cyber-home--light .cyber-backdrop__beam--violet {
  background: linear-gradient(90deg, transparent, rgba(139, 92, 246, 0.12), transparent);
}

.cyber-home--light .cyber-backdrop__noise {
  opacity: 0.05;
  background-image:
...
.cyber-home--light .cyber-brand__name,
.cyber-home--light .cyber-login-link,
.cyber-home--light .cyber-icon-button {
  color: #0f2740;
}

.cyber-home--light .cyber-brand__mode {
  color: #0891b2;
}

.cyber-home--light .cyber-brand__mark {
  background: #ffffff;
...
.cyber-home--light .cyber-icon-button,
.cyber-home--light .cyber-login-link,
.cyber-home--light .cyber-locale-control {
  background: rgba(255, 255, 255, 0.92);
  border-color: rgba(14, 116, 144, 0.18);
  color: #0f2740;
}

.cyber-home--light .cyber-icon-button:hover,
.cyber-home--light .cyber-login-link:hover {
  border-color: #0891b2;
...
.cyber-home--light .cyber-eyebrow {
  color: #15803d;
}

.cyber-home--light .cyber-eyebrow__pulse {
  border-color: #22c55e;
  background: #ffffff;
  box-shadow: 0 0 12px rgba(34, 197, 94, 0.35);
}

.cyber-home--light .cyber-title {
  color: #0b1b2b;
  text-shadow: none;
}

.cyber-home--light .cyber-title > span {
  background: linear-gradient(
    90deg,
    #0b1b2b 0%,
    #0891b2 23%,
...
.cyber-home--light .cyber-title strong {
  color: #164e63;
}

.cyber-home--light .cyber-description,
.cyber-home--light .cyber-section-heading p,
.cyber-home--light .cyber-final-cta p,
.cyber-home--light .cyber-capability-card p,
.cyber-home--light .cyber-advantage-card p,
.cyber-home--light .cyber-workflow-step p {
  color: #475569;
}

.cyber-home--light .cyber-button--primary {
...
.cyber-home--light .cyber-button--secondary {
  border-color: rgba(8, 145, 178, 0.35);
  background: rgba(255, 255, 255, 0.92);
  color: #0e7490;
}

.cyber-home--light .cyber-button--secondary:hover {
  border-color: rgba(124, 58, 237, 0.45);
  background: rgba(124, 58, 237, 0.06);
}

.cyber-home--light .cyber-signal {
  background: rgba(255, 255, 255, 0.78);
  border-color: rgba(8, 145, 178, 0.18);
}

.cyber-home--light .cyber-signal dt {
  color: #64748b;
}

.cyber-home--light .cyber-signal dd {
  color: #0f2740;
}

.cyber-home--light .gateway-panel,
.cyber-home--light .cyber-terminal,
.cyber-home--light .cyber-capability-card,
.cyber-home--light .cyber-advantage-card,
.cyber-home--light .cyber-workflow-step,
.cyber-home--light .cyber-final-cta {
  border-color: rgba(8, 145, 178, 0.18);
  background:
...
.cyber-home--light .gateway-panel__header,
.cyber-home--light .cyber-terminal__bar {
  color: #64748b;
}

.cyber-home--light .gateway-panel__header strong,
.cyber-home--light .cyber-terminal__bar strong,
.cyber-home--light .cyber-section-heading span,
.cyber-home--light .cyber-final-cta__eyebrow,
.cyber-home--light .cyber-terminal__body span,
.cyber-home--light .cyber-terminal__success {
  color: #16a34a;
}

.cyber-home--light .gateway-route-map {
...
.cyber-home--light .gateway-node small {
  color: #64748b;
}

.cyber-home--light .gateway-node--core {
  border-color: rgba(22, 163, 74, 0.55);
  box-shadow: 0 8px 22px rgba(34, 197, 94, 0.16);
}

.cyber-home--light .gateway-route {
...
.cyber-home--light .cyber-terminal__body {
  color: #0f2740;
}

.cyber-home--light .cyber-section-heading h2,
.cyber-home--light .cyber-final-cta h2,
.cyber-home--light .cyber-capability-card h3,
.cyber-home--light .cyber-advantage-card h3,
.cyber-home--light .cyber-workflow-step h3 {
  color: #0b1b2b;
  text-shadow: none;
}

.cyber-home--light .cyber-card-icon {
  border-color: rgba(22, 163, 74, 0.35);
  color: #16a34a;
  background: rgba(34, 197, 94, 0.08);
}

.cyber-home--light .cyber-capability-card code {
  border-color: rgba(8, 145, 178, 0.2);
  color: #0e7490;
  background: rgba(241, 245, 249, 0.9);
}

.cyber-home--light .cyber-advantage-card__index,
.cyber-home--light .cyber-workflow-step__number {
  color: #0891b2;
}
...
.cyber-home--light .cyber-advantage-card__meter {
  background: rgba(8, 145, 178, 0.12);
}

.cyber-home--light .cyber-advantage-card:hover,
.cyber-home--light .cyber-capability-card:hover,
.cyber-home--light .cyber-workflow-step:hover {
  border-color: rgba(22, 163, 74, 0.4);
  box-shadow:
    inset 0 0 0 1px rgba(34, 197, 94, 0.08),
    0 16px 40px rgba(8, 145, 178, 0.1);
}

.cyber-home--light .cyber-advantage-card::before,
.cyber-home--light .cyber-capability-card::before,
.cyber-home--light .cyber-workflow-step::before {
  background:
    linear-gradient(110deg, transparent 0 38%, rgba(8, 145, 178, 0.1) 48%, transparent 58%),
    repeating-linear-gradient(0deg, rgba(15, 23, 42, 0.03) 0 1px, transparent 1px 10px);
}

.cyber-home--light .cyber-footer {
  border-top-color: rgba(8, 145, 178, 0.14);
  background: rgba(255, 255, 255, 0.55);
}

.cyber-home--light .cyber-footer__copy {
  color: #64748b;
}

.cyber-home--light .cyber-footer__link {
  color: #475569;
}

.cyber-home--light .cyber-footer__link:hover {
  color: #0e7490;
}

/* LocaleSwitcher inside cyber header (light) */
.cyber-home--light .cyber-locale-control :deep(button) {
  border-color: rgba(14, 116, 144, 0.18);
  background: rgba(255, 255, 255, 0.92);
  color: #0f2740;
}

.cyber-home--light .cyber-locale-control :deep(button:hover) {
  background: rgba(8, 145, 178, 0.08);
  color: #0e7490;
}

.cyber-home--light .cyber-locale-control :deep(.absolute) {
  border-color: rgba(14, 116, 144, 0.18);
...
@media (max-width: 720px) {
  ...
  /* Keep route demo readable on narrow phones */
  .gateway-node span,
  .gateway-node strong {
    font-size: 12px;
  }
