...
func TestStripOpenAIImageGenerationTools_DropsToolsKeyWhenEmpty(t *testing.T) {
	reqBody := map[string]any{
		"model": "gpt-5.2",
		"tools": []any{
			map[string]any{"type": "image_generation"},
...
func TestStripOpenAIImageGenerationTools_NoopWhenAbsent(t *testing.T) {
	reqBody := map[string]any{
		"model": "gpt-5.2",
		"tools": []any{
			map[string]any{"type": "function", "name": "shell"},
...
// P1 回归：顶层 image_gen namespace 工具也必须剥离，否则 hasOpenAIImageGenerationTool
// 仍为 true → 在禁用生图分组被判定 imageIntent 返回 403。
func TestStripOpenAIImageGenerationTools_RemovesTopLevelNamespace(t *testing.T) {
	reqBody := map[string]any{
		"model": "gpt-5.4",
		"tools": []any{
			map[string]any{"type": "function", "name": "shell"},
...
// 剥离后 hasOpenAIImageGenerationTool 必须为 false。
func TestStripOpenAIImageGenerationTools_RemovesAdditionalToolsNamespace(t *testing.T) {
	reqBody := map[string]any{
		"model": "gpt-5.4",
		"input": []any{
...
func TestStripOpenAIImageGenerationTools_KeepsOtherAdditionalTools(t *testing.T) {
	reqBody := map[string]any{
		"model": "gpt-5.4",
		"input": []any{
			map[string]any{
				...
				"tools": []any{
					map[string]any{"type": "namespace", "name": "image_gen"},
					map[string]any{"type": "namespace", "name": "web_search"},
				},
			},
		},
	}
